...
class ExecutionEngine(hitchtest.ExecutionEngine):
    ...
    def set_up(self):
        ...
        postgres_user = hitchpostgres.PostgresUser("iceraitings_cookie_project", "password")

        self.services['Postgres'] = hitchpostgres.PostgresService(
            postgres_package=postgres_package,
            users=[postgres_user, ],
            databases=[hitchpostgres.PostgresDatabase("iceraitings_cookie_project", postgres_user), ]
        )
